...
# https://opus.nci.org.au/display/Help/How+to+submit+a+job
 #PBS -N BIOS_BLAZE_tests_act9_serial
 #PBS -P x45
...
experiment=BLAZE25_serial_newswitch  #experiment name
...
domain='acttest9'     #  bios domain - 'acttest9','reccap1000pts','aust_0.25_pts','australia'
...
# global Cable namelist - if BLAZE active then blaze-climate metrics on in all steps (rblaze=1)
cat > ${tmp}/sedtmp.${pid} << EOF

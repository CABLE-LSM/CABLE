...
gridinfo_file=basepath + 'surface_data/gridinfo_CSIRO_1x1.nc'   # path/name of gridinfo file
...
landlonlat=alllonlat.loc[(alllonlat['iveg'] > -1) & (alllonlat['iveg'] < 15)]
points=landlonlat.iloc[random.sample(range(0,landlonlat.shape[0]-1),nrpoints),:]

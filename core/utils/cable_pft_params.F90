  ...
  SUBROUTINE cable_pft_params()
    ...
    IF( first_call ) THEN
       ...
       ALLOCATE (                                                               &
            ...
            vegin%P12(mvtype), vegin%P50(mvtype), vegin%P88(mvtype),              &

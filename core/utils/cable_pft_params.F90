...
CONTAINS
  ...
  SUBROUTINE cable_pft_params()
    ...
    IF( first_call ) THEN
       ...
       vegin%Kmax(18) = 1.5 ! 0.75
       vegin%Kcrit(18) = 0.075 ! vegin%Kmax * 0.05 ! 0.0375
       ...
       vegin%Kmax(19) = 1.5 ! 0.75
       vegin%Kcrit(19) = 0.075 ! vegin%Kmax * 0.05 ! 0.0375
       ...
       vegin%Kmax(20) = 1.5 ! 0.75
       vegin%Kcrit(20) = 0.075 ! vegin%Kmax * 0.05 ! 0.0375
       ...
       vegin%Kmax(21) = 1.5 ! 0.75
       vegin%Kcrit(21) = 0.075 ! vegin%Kmax * 0.05 ! 0.0375
       ...
       vegin%Kmax(22) = 1.5 ! 0.75
       vegin%Kcrit(22) = 0.075 ! vegin%Kmax * 0.05 ! 0.0375
       ...
       vegin%Kmax(23) = 1.5 ! 0.75
       vegin%Kcrit(23) = 0.075 ! vegin%Kmax * 0.05 ! 0.0375
       ...
       vegin%Kmax(24) = 1.5 ! 0.75
       vegin%Kcrit(24) = 0.075 ! vegin%Kmax * 0.05 ! 0.0375
       ...
       vegin%Kmax(25) = 1.5 ! 0.75
       vegin%Kcrit(25) = 0.075 ! vegin%Kmax * 0.05 ! 0.0375
       ...
       vegin%Kmax(26) = 1.5 ! 0.75
       vegin%Kcrit(26) = 0.075 ! vegin%Kmax * 0.05 ! 0.0375
       ...
       vegin%Kmax(27) = 1.5 ! 0.75
       vegin%Kcrit(27) = 0.075 ! vegin%Kmax * 0.05 ! 0.0375
       ...
       vegin%Kmax(28) = 1.5 ! 0.75
       vegin%Kcrit(28) = 0.075 ! vegin%Kmax * 0.05 ! 0.0375
       ...
       vegin%Kmax(29) = 1.5 ! 0.75
       vegin%Kcrit(29) = 0.075 ! vegin%Kmax * 0.05 ! 0.0375
       ...
       vegin%Kmax(30) = 1.5 ! 0.75
       vegin%Kcrit(30) = 0.075 ! vegin%Kmax * 0.05 ! 0.0375
       ...
       vegin%Kmax(31) = 1.5 ! 0.75
       vegin%Kcrit(31) = 0.075 ! vegin%Kmax * 0.05 ! 0.0375
       ...
       vegin%Kmax(32) = 1.5 ! 0.75
       vegin%Kcrit(32) = 0.075 ! vegin%Kmax * 0.05 ! 0.0375

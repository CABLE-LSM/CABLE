...
!*******************************************************************************
  SUBROUTINE WRITE_BLAZE_OUTPUT_NC ( BLAZE, FINAL )
    ...
    INTEGER   :: i, mp
    !CLNINTEGER, PARAMETER :: NFLUXES = 14
...
!!$         count=(/ mp, 1 /) )
 ...
 SUBROUTINE update_sumBLAZE(BLAZE, sumBLAZE, count)
   ...
   !update sumBLAZE time - will take the value at the middle of the averaging period
   if (count == 1) then

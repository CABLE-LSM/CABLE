...
CONTAINS
  ...
  SUBROUTINE define_canopy(bal,rad,rough,air,met,dels,ssnow,soil,veg, canopy,climate)
    ...
    DO j=1,mp
       ...
       IF ( canopy%vlaiw(j) > C%LAI_THRESH .and. rough%hruff(j) > 0.01) THEN
          ...
          ! ____________________________ MMY ________________________________
  ...
  SUBROUTINE dryLeaf( dels, rad, rough, air, met,                                &
    ...
    REAL, DIMENSION(0:ms+1) :: diff ! MMY
    REAL :: xx,xxd                  ! MMY
          ...
          IF (canopy%vlaiw(i) > C%LAI_THRESH .AND. abs_deltlf(i) > 0.1 ) Then
             ...
             ELSE
                ...
                IF (ecx(i) > 0.0 .AND. canopy%fwet(i) < 1.0) Then
                  ...
                  ! _____________________ MMY comment out _________________________
                  ! DO kk = 1,ms
                  ...
                  ! _______________ MMY modify from cable_gw_hydro ________________

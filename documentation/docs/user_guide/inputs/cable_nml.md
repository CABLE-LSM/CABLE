...
|------------------------------|------|------------------------------------------|------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------|
| filename%met                 | character |                                     | '/projects/access/CABLE-AUX/offline/TumbaFluxnet.1.3_met.nc'                 | Meteorological forcing file                                                                              |
| filename%out                 | character |                                     | 'out_cable.nc'                                                               | Output file                                                                                              |
| filename%log                 | character |                                     | 'log_cable.txt'                                                              | Log file                                                                                                 |
| filename%restart_in          | character |                                     | ' '                                                                          | Input restart file                                                                                       |
| filename%restart_out         | character |                                     | './restart_out.nc'                                                           | Output restart file                                                                                      |
| filename%type                | character |                                     | '/projects/access/CABLE-AUX/offline/gridinfo_CSIRO_1x1.nc'                   | Gridinfo file                                                                                            |
| filename%veg                 | character |                                     | '/projects/access/CABLE-AUX/core/biogeophys/veg_params_vbeta1.txt'           | Vegetation parameters file (obsolete, vegetation parameters are now in the pft_params.nml file)          |
| filename%soil                | character |                                     | '/projects/access/CABLE-AUX/core/biogeophys/def_soil_params.txt'             | Soil parameters file ((obsolete, vegetation parameters are n:wow in the cable_soilparm.nml file)         |
...
| fixedCO2                     | integer   |                                     | 350                                                                          | if not found in met file, in ppmv                                                                        |
...
| casafile%cnpipool            | character |                                     | '/projects/access/CABLE-AUX/core/biogeochem/poolcnpInTumbarumba.csv'         |                                                                                                          |
| casafile%cnpbiome            | character |                                     | '/projects/access/CABLE-AUX/core/biogeochem/pftlookup_csiro_v16_17tiles.csv' | biome specific BGC parameters                                                                            |
| casafile%cnpepool            | character |                                     | 'poolcnpOut.csv'                                                             | end of run pool size                                                                                     |
| casafile%cnpmetout           | character |                                     | 'casamet.nc'                                                                 | output daily met forcing for spinning casacnp                                                            |
| casafile%cnpmetin            | character |                                     | ''                                                                           | list of daily met files for spinning casacnp                                                             |
| casafile%phen                | character |                                     | '/projects/access/CABLE-AUX/core/biogeochem/modis_phenology_csiro.txt'       | modis phenology                                                                                          |
| casafile%cnpflux             | character |                                     | 'cnpfluxOut.csv'                                                             |                                                                                                          |
| ncciy                        | integer   |                                     | 0                                                                            | 0 for not using gswp; 4-digit year input for year of gswp met                                            |
| gswpfile%rainf               | character |                                     | 'gswp/Rainf_gswp1987.nc'                                                     |                                                                                                          |
| gswpfile%snowf               | character |                                     | 'gswp/Snowf_gswp1987.nc'                                                     |                                                                                                          |
| gswpfile%LWdown              | character |                                     | 'gswp/LWdown_srb1987.nc'                                                     |                                                                                                          |
| gswpfile%SWdown              | character |                                     | 'gswp/SWdown_srb1987.nc'                                                     |                                                                                                          |
| gswpfile%PSurf               | character |                                     | 'gswp/PSurf_ecor1987.nc'                                                     |                                                                                                          |
| gswpfile%Qair                | character |                                     | 'gswp/Qair_cru1987.nc'                                                       |                                                                                                          |
| gswpfile%Tair                | character |                                     | 'gswp/Tair_cru1987.nc'                                                       |                                                                                                          |
| gswpfile%wind                | character |                                     | 'gswp/Wind_ncep1987.nc'                                                      |                                                                                                          |
...
| cable_user%DIAG_SOIL_RESP    | character |                                     | 'ON '                                                                        |                                                                                                          |
| cable_user%LEAF_RESPIRATION  | character |                                     | 'ON '                                                                        |                                                                                                          |
...
| cable_user%SSNOW_POTEV       | character |                                     | 'HDM'                                                                        | Humidity Deficit Method                                                                                  |

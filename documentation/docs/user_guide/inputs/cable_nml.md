...
| filename%type                | character(len=500) | any string of max. 500 characters | '/projects/access/CABLE-AUX/offline/gridinfo_CSIRO_1x1.nc'            | Gridinfo file                                                                                            |
| filename%veg                 | character(len=500) | any string of max. 500 characters | '/projects/access/CABLE-AUX/core/biogeophys/veg_params_vbeta1.txt'    | Vegetation parameters file (obsolete, vegetation parameters are now in the pft_params.nml file)          |
| filename%soil                | character(len=500) | any string of max. 500 characters | '/projects/access/CABLE-AUX/core/biogeophys/def_soil_params.txt'      | Soil parameters file ((obsolete, vegetation parameters are now in the cable_soilparm.nml file)           |
...
| delsoilT                     | real      |  any real number                    | 0.01                                                                         | Allowed variation in soil temperaTRUE for spin up                                                        |
...
| verbose                      | logical   | .TRUE. .FALSE.                      | .TRUE.                                                                       | write details of every grid cell init and params to log?                                                 |
...
| l_casacnp                    | logical   | .TRUE. .FALSE.                      | .FALSE.                                                                      | using casaCNP with CABLE                                                                                 |
| l_laiFeedbk                  | logical   | .TRUE. .FALSE.                      | .FALSE.                                                                      | using prognostic LAI                                                                                     |
| l_vcmaxFeedbk                | logical   | .TRUE. .FALSE.                      | .FALSE.                                                                      | using prognostic Vcmax                                                                                   |
...
| casafile%cnpipool            | character(len=99) | any string of max. 99 characters | '/projects/access/CABLE-AUX/core/biogeochem/poolcnpInTumbarumba.csv'    |                                                                                                          |
| casafile%cnpbiome            | character(len=99) | any string of max. 99 characters | '/projects/access/CABLE-AUX/core/biogeochem/pftlookup_csiro_v16_17tiles.csv' | biome specific BGC parameters                                                                       |
| casafile%cnpepool            | character(len=99) | any string of max. 99 characters | 'poolcnpOut.csv'                                                        | end of run pool size                                                                                     |
| casafile%cnpmetout           | character(len=99) | any string of max. 99 characters | 'casamet.nc'                                                            | output daily met forcing for spinning casacnp                                                            |
| casafile%cnpmetin            | character(len=99) | any string of max. 99 characters | ''                                                                      | list of daily met files for spinning casacnp                                                             |
...
| cable_user%DIAG_SOIL_RESP    | character(len=3) | 'ON ' 'OFF'                  | 'ON '                                                                        |                                                                                                          |
| cable_user%LEAF_RESPIRATION  | character(len=3) | 'ON ' 'OFF'                  | 'ON '                                                                        |                                                                                                          |

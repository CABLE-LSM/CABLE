...
| fixedCO2                     |      |                                          | 350                                                                          | if not found in met file, in ppmv                                                                        |
...
| icycle                       |      |                                          | 0                                                                            | 0 for not using casaCNP, 1 for C, 2 for C+N, 3 for C+N+P, >10 excludes call to CBM (main call to cable)  |

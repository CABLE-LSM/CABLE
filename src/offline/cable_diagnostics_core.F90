module cable_diagnostics_core_mod
  ...
  use cable_output_mod, only: DIM_PATCH => CABLE_OUTPUT_DIM_PATCH
  use cable_output_mod, only: DIM_SOIL => CABLE_OUTPUT_DIM_SOIL
  use cable_output_mod, only: DIM_RAD => CABLE_OUTPUT_DIM_RAD
  use cable_output_mod, only: DIM_SNOW => CABLE_OUTPUT_DIM_SNOW
  use cable_output_mod, only: DIM_PLANTCARBON => CABLE_OUTPUT_DIM_PLANTCARBON
  use cable_output_mod, only: DIM_SOILCARBON => CABLE_OUTPUT_DIM_SOILCARBON
  use cable_output_mod, only: DIM_LAND_GLOBAL => CABLE_OUTPUT_DIM_LAND_GLOBAL

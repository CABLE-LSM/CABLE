module cable_diagnostics_mod
  ...
  use cable_output_mod, only: cable_output_dim_t
  use cable_output_mod, only: attribute => cable_output_attribute_t
  ...
  public :: cable_diagnostics

contains

  function cable_diagnostics(met, canopy, soil, ssnow, rad, veg, bal, rough, bgc, dels) result(output_variables)
    ...
    type(cable_output_dim_t) :: dim_patch
    type(cable_output_dim_t) :: dim_soil
    type(cable_output_dim_t) :: dim_rad
    type(cable_output_dim_t) :: dim_snow
    type(cable_output_dim_t) :: dim_plant_carbon
    type(cable_output_dim_t) :: dim_soil_carbon
    type(cable_output_dim_t) :: dim_land_global

    dim_patch = cable_output_get_dimension("patch")
    dim_soil = cable_output_get_dimension("soil")
    dim_rad = cable_output_get_dimension("rad")
    dim_snow = cable_output_get_dimension("snow")
    dim_plant_carbon = cable_output_get_dimension("plant_carbon_pools")
    dim_soil_carbon = cable_output_get_dimension("soil_carbon_pools")
    ...
    output_variables = [ &
      ...
      cable_output_variable_t( &
        ...
        active=(output%radiation .or. output%visAlbedo) .and. calcsoilalbedo, &
      ...
      cable_output_variable_t( &
        ...
        active=(output%radiation .or. output%nirAlbedo) .and. calcsoilalbedo, &
      ...
      cable_output_variable_t( &
        ...
        active=(output%soil .or. output%WatTable) .and. cable_user%gw_model, &
      ...
      cable_output_variable_t( &
        ...
        var_type=CABLE_NETCDF_FLOAT, &
        range=ranges%GWwb, &
        active=(output%soil .or. output%GWMoist) .and. cable_user%gw_model, &
      ...
      cable_output_variable_t( &
        ...
        active=(output%soil .or. output%SatFrac) .and. cable_user%gw_model, &
      ...
      cable_output_variable_t( &
        field_name="cplant", &
        data_shape=[dim_patch, dim_plant_carbon], &
        var_type=CABLE_NETCDF_FLOAT, &
        active=.false., &
        restart=.true., &
      ...
      cable_output_variable_t( &
        field_name="csoil", &
        data_shape=[dim_patch, dim_soil_carbon], &
        var_type=CABLE_NETCDF_FLOAT, &
        active=.false., &
        restart=.true., &
  ...
  end function cable_diagnostics

module cable_output_definitions_mod
  ...
  use cable_output_types_mod, only: DIM_SNOW => CABLE_OUTPUT_DIM_SNOW
  use cable_output_types_mod, only: DIM_PLANTCARBON => CABLE_OUTPUT_DIM_PLANTCARBON
  use cable_output_types_mod, only: DIM_SOILCARBON => CABLE_OUTPUT_DIM_SOILCARBON
...
contains
  ...
  function core_outputs(dels, met, canopy, soil, ssnow, rad, veg, bal, casaflux, casapool, casamet, rough, bgc) result(output_variables)
    real, intent(in) :: dels
    ...
    output_variables = [ &
      casa_cnp_outputs(casaflux, casapool, casamet), &
  ...
  function casa_cnp_outputs(casaflux, casapool, casamet) result(casa_output_variables)

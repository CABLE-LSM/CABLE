...
contains
  ...
  function type_pio(basetype)
    ...
    case(CABLE_NETCDF_DOUBLE)
      type_pio = PIO_DOUBLE
    case default
      call cable_abort("cable_netcdf_pio_mod: Error: type not supported", file=__FILE__, line=__LINE__)
    end select
  ...
  function iotype_pio(iotype)
    ...
    case default
      call cable_abort("cable_netcdf_pio_mod: Error: iotype not supported", file=__FILE__, line=__LINE__)
    end select
  ...
  function mode_pio(mode)
    ...
    case default
      call cable_abort("Error: mode not supported", file=__FILE__, line=__LINE__)
    end select
  ...
  function rearranger_pio(rearr)
    ...
    case default
      call cable_abort("Error: invalid rearranger", file=__FILE__, line=__LINE__)
    end select

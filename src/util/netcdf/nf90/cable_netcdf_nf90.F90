...
contains
  ...
  function type_nf90(type)
    ...
    case default
      call cable_abort("cable_netcdf_nf90_mod: Error: type not supported", file=__FILE__, line=__LINE__)
    end select
  ...
  function cmode_nf90(iotype, mode)
    ...
    case default
      call cable_abort("Error: iotype not supported", file=__FILE__, line=__LINE__)
    end select

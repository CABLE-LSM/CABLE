...
CONTAINS
  ...
  SUBROUTINE alloc_casavariable(casabiome,casapool,casaflux,casamet,casabal,arraysize)
    !* Allocate casabiome, casapool, casaflux, casamet and casabal derived type instances.
    ...
    ALLOCATE(casabiome%ivt2(mvtype), source=0)
    ALLOCATE(                                   &
    ...
    ALLOCATE(                                                  &
      ...
      casaflux%meangpp(arraysize),                             &
      casaflux%meanrleaf(arraysize),                           &
      source=0.0_r_2                                           &
    )
